...
1 **How to retrieve all the bills (i.e., __AppliedCustomerBillingRate_) related to a Product for a period coverage**
  - To retrieve the list of the bills (i.e., ACBR) generated by the billing subsystem and related to a specific Product and period coverage will be used the `GET` method with the following filters:
