...
|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| access-node.desmos.enabled                               | should the desmos-blockchain-connector be enabled                                                                                                        | true                                                                                                                                                                                   |
| access-node.desmos.app.profile                           | profile (dev == sbx)                                                                                                                                     | dev                                                                                                                                                                                    |
| access-node.desmos.app.logLevel                          | debug level                                                                                                                                              | false                                                                                                                                                                                  |
| access-node.desmos.app.operator.organizationIdentifier   | did of the organization running the node                                                                                                                 | did:elsi:VATES-S9999999                                                                                                                                                                |
| access-node.desmos.broker.provider                       | provider of the broker                                                                                                                                   | scorpio                                                                                                                                                                                |
| access-node.desmos.broker.internalDomain                 | internal address of the context broker to be used by the connector                                                                                       | http://scorpio:9090                                                                                                                                                                    |
| access-node.desmos.broker.externalDomain                 | external address of the broker. Will be included in the hashlink and used by other access-nodes to retrieve the actual entities                          | http://scorpio:9090                                                                                                                                                                    |
| access-node.desmos.ngsiSubscription.notificationEndpoint | local address of the blockchain-connectors notification endpoint for ngsi-ld events                                                                      | http://desmos:8080/notifications/broker                                                                                                                                                |
| access-node.desmos.ngsiSubscription.entityTypes          | a list of entity-types the connector is interested in                                                                                                    | catalog,product-offering,category,individual,organization,product,service-specification,product-offering-price,resource-specification,product-specification                            |
| access-node.desmos.dltAdapter.provider                   | provider of the dlt-adapter component                                                                                                                    | digitelts                                                                                                                                                                              |
| access-node.desmos.dltAdapter.internalDomain             | (local) address of the dlt-adapter                                                                                                                       | http://dlt-adapter:80                                                                                                                                                                  |
| access-node.desmos.dltAdapter.externalDomain             | (external) address of the dlt-adapter                                                                                                                    | http://dlt-adapter:80                                                                                                                                                                  |
| access-node.desmos.txSubscription.notificationEndpoint   | local address of the blockchain-connectors notification endpoint for dlt events                                                                          | http://desmos:8080/notifications/dlt                                                                                                                                                   |
| access-node.desmos.txSubscription.entityTypes            | a list of entity-types the connector is interested in                                                                                                    | catalog,product-offering,category,individual,organization,product,service-specification,product-offering-price,resource-specification,product-specification                            |
| access-node.desmos.db.host                               | host of the db                                                                                                                                           | postgresql-connector                                                                                                                                                                   |
| access-node.desmos.db.password                           | password to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.desmos.db.username                           | username to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.desmos.fullnameOverride                      | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | desmos                                                                                                                                                                                 |
| access-node.dlt-adapter.enabled                          | should the dlt-adapter be enabled                                                                                                                        | true                                                                                                                                                                                   |
| access-node.dlt-adapter.fullnameOverride                 | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | dlt-adapter                                                                                                                                                                            |
| access-node.dlt-adapter.env.DEBUG                        |                                                                                                                                                          | *                                                                                                                                                                                      |
| access-node.dlt-adapter.env.PRIVATE_KEY                  |                                                                                                                                                          | 0xe2afef2c880b138d741995ba56936e389b0b5dd2943e21e4363cc70d81c89346                                                                                                                     |
| access-node.dlt-adapter.env.RPC_ADDRESS                  |                                                                                                                                                          | https://red-t.alastria.io/v0/9461d9f4292b41230527d57ee90652a6                                                                                                                          |
| access-node.dlt-adapter.env.ISS                          |                                                                                                                                                          | 0x43b27fef24cfe8a0b797ed8a36de2884f9963c0c2a0da640e3ec7ad6cd0c493d                                                                                                                     |
| access-node.postgresql.enabled                           | should the postgresql deployment be enabled                                                                                                              | true                                                                                                                                                                                   |
| access-node.postgresql.fullnameOverride                  | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | postgresql-connector                                                                                                                                                                   |
| access-node.postgresql.nameOverride                      | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | postgresql-connector                                                                                                                                                                   |
| access-node.postgresql.auth.username                     | username to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.postgresql.auth.enablePostgresUser           | should the default postgres user be enabled                                                                                                              | true                                                                                                                                                                                   |
| access-node.postgresql.auth.password                     | password to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.postgresql.primary.initdb.scripts.create.sh  | create the database as expected by the blockchain-connector                                                                                              | psql postgresql://postgres:${POSTGRES_PASSWORD}@localhost:5432 -c "CREATE DATABASE mktdb;"                                                                                             |
| access-node.scorpio.enabled                              | should scorpio be enabled                                                                                                                                | true                                                                                                                                                                                   |
| access-node.scorpio.image.repository                     | repository to be used - resource friendly all-in-one-runner without kafka                                                                                | scorpiobroker/all-in-one-runner                                                                                                                                                        |
| access-node.scorpio.image.tag                            | tag of the image to be used - latest java image without kafka                                                                                            | java-4.1.11                                                                                                                                                                            |
| access-node.scorpio.db.dbhost                            | host of the db                                                                                                                                           | postgis                                                                                                                                                                                |
| access-node.scorpio.db.user                              | username to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.scorpio.db.password                          | password to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.scorpio.readinessProbe.path                  | path to be used for the readiness probe, older versions used /actuator/health                                                                            | /q/health                                                                                                                                                                              |
| access-node.scorpio.livenessProbe.path                   | path to be used for the readiness probe, older versions used /actuator/health                                                                            | /q/health                                                                                                                                                                              |
| access-node.scorpio.fullnameOverride                     | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | scorpio                                                                                                                                                                                |
| access-node.scorpio.service.type                         | ClusterIP is the recommended type for most clusters                                                                                                      | ClusterIP                                                                                                                                                                              |
| access-node.kafka.enabled                                | should kafka be enabled?                                                                                                                                 | false                                                                                                                                                                                  |
| access-node.postgis.enabled                              | should postgis be enabled                                                                                                                                | true                                                                                                                                                                                   |
| access-node.postgis.fullnameOverride                     | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | postgis                                                                                                                                                                                |
| access-node.postgis.nameOverride                         | overrides the generated name, provides stable service names - this should be avoided if multiple instances are available in the same namespace           | postgis                                                                                                                                                                                |
| access-node.postgis.auth.username                        | username to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.postgis.auth.enablePostgresUser              | should the default postgres user be enabled                                                                                                              | true                                                                                                                                                                                   |
| access-node.postgis.auth.password                        | password to be used                                                                                                                                      | postgres                                                                                                                                                                               |
| access-node.postgis.primary.initdb.scripts.enable.sh     | enable the postgis extension and create the database as expected by scorpio                                                                              | psql postgresql://postgres:${POSTGRES_PASSWORD}@localhost:5432 -c "CREATE EXTENSION postgis;" psql postgresql://postgres:${POSTGRES_PASSWORD}@localhost:5432 -c "CREATE DATABASE ngb;" |
| access-node.tm-forum-api.enabled                         | should tm-forum-api be enabled                                                                                                                           | true                                                                                                                                                                                   |
| access-node.tm-forum-api.defaultConfig.image.tag         | current latest tag                                                                                                                                       | 0.16.0                                                                                                                                                                                 |
| access-node.tm-forum-api.defaultConfig.ngsiLd.url        | address of the broker                                                                                                                                    | http://scorpio:9090                                                                                                                                                                    |
| access-node.tm-forum-api.defaultConfig.contextUrl        | default context to be used when contacting the context broker                                                                                            | https://uri.etsi.org/ngsi-ld/v1/ngsi-ld-core-context.jsonld                                                                                                                            |
| access-node.tm-forum-api.defaultConfig.serverHost        | host that the tm-forum api can be reached at, when the proxy is enabled it should be set to that address. If not, set the host for each api individually | http://localhost:8080                                                                                                                                                                  |
| access-node.tm-forum-api.apiProxy.enabled                | should the proxy be enabled                                                                                                                              | true                                                                                                                                                                                   |
